...
#
def init(user=None, specif_project= 'geo-datasciencesol'):
    ...
    if sa:
        ...
        ee.Initialize(project= specif_project)
...
def tasks(n=25,task_id=None,description=None,states=None,
    ...
    for task_dict in task_list[:n]: 
        ...
        if print_tasks: print("informando report ", task_report)
...
def _status(args):
    print ("informando status ", get_status(args.task_id))
